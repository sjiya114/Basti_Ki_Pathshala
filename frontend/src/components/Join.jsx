...
function Join() {
    ...
    const paragraph = "At Basti Ki Pathshala Foundation,we are not  just building a team; we’re assembling  a force for change. As we continue our  mission to break barriers and empower communities through  education, we invite passionate individuals to join us in  making a tangible difference in the lives of underserved children. Whether you’re a seasoned educator, a community organizer, or simply someone with a heart for social impact, there’s a place for you in our team. Together, we’ll collaborate, innovate, and inspire, working towards a future where every child has the opportunity to thrive.Join us in this rewarding journey of transformation. Together,let’s pave the way for brighter tomorrows and empower futures, one child at a time."
    ...
    return (
        <div id='join' className='flex flex-row  max-md:flex-col mt-30 hover:scale-110 max-w-screen-xl mx-auto'>
            ...
            <div className='w-1/2 max-md:w-full text-white px-6 py-4'>
                ...
                {/* <p id='para' className='mt-6 tracking-wide '>At Basti Ki Pathshala Foundation, we’re not
                  ...
                  <div className='tracking-wider'>
                     {parag.map((data,index)=>(
                    <p  style={{animationDelay:`${index*0.05}s`}} className='para inline opacity-0'>{data+" "}</p>
                 ))
                 }
                  </div>
